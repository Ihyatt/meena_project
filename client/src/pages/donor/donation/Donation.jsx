              ...
              <form onSubmit={handleDonateClick}>
                ...
                <div className="mt-4 mb-5">
                  <div className="flex m-2 text-sm text-gray-400 font-light">
                    ...
                    I accept and agree to the  <div className="ml-1 inline font-semibold cursor-pointer hover:underline" onClick={() => handleOpen("lg")}>terms and conditions</div>
                    <TermsAndConditions onHandleOpenChild={handleOpen} />
                    <div className="inline-flex items-center mr-1">
                      <label className="flex items-center cursor-pointer relative">
                        <input
